...
<?php echo tep_draw_form('account_notifications', tep_href_link('account_newsletters.php', '', 'SSL'), 'post', 'class="form-horizontal"', true) . tep_draw_hidden_field('action', 'process'); ?>
