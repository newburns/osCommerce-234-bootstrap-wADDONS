...
<?php
    ...
    ?>
      <tr><?php echo tep_draw_form('review', 'reviews.php', 'action=addnewtestimonial'); ?>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
...
?>
                <td class="dataTableContent"><?php echo '<a href="' . tep_href_link('reviews.php', 'page=' . $HTTP_GET_VARS['page'] . '&rID=' . $reviews['reviews_id'] . '&action=preview') . '">' . tep_image(DIR_WS_ICONS . 'preview.gif', ICON_PREVIEW) . '</a>&nbsp;' . tep_get_products_name_review($reviews['products_id']); ?></td>
...
?>
              <tr>
                <td colspan="6"><table border="0" width="100%" cellspacing="0" cellpadding="2">
	              ...
	              <tr>
                    <td colspan="2" class="smallText" align="right"><?php echo tep_draw_button(IMAGE_BUTTON_ADD_REVIEW, 'triangle-1-e', tep_href_link('reviews.php', 'action=new')) . tep_draw_button(IMAGE_BUTTON_ADD_TESTIMONIAL, 'triangle-1-e', tep_href_link('reviews.php', 'action=newtestimonial')); ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
