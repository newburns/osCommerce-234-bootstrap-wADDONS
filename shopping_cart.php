...
<?php
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      ...
      $products_name .= '  <td valign="top" align="center"><a href="' . tep_href_link('product_info', 'products_id=' . $products[$i]['id']) . '">' . tep_image(DIR_WS_IMAGES . $products[$i]['image'], $products[$i]['name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a></td>' .
                        '  <td valign="top"><a href="' . tep_href_link('product_info', 'products_id=' . $products[$i]['id']) . '"><strong>' . $products[$i]['name'] . '</strong></a>';
